...
namespace Dormarch.OpenType
{
    ...
    public class HighByteSubheaderCharacterMapping : CharacterMapping
    {
        ...
        /// <param name="encoding">Value for the <see cref="CharacterMapping.Encoding" /> property.</param>
        /// <param name="lang">Value for the <see cref="CharacterMapping.Language" /> property.</param>
